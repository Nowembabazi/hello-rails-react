...
Feel free to check the [issues page](https://github.com/Nowembabazi/hello-rails-react/issues).
...
This project is [MIT](https://github.com/Nowembabazi/budget-app/blob/dev/LICENSE) licensed.
